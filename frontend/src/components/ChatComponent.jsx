...
const ChatComponent = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-100 dark:bg-gray-950 pt-16">
      {/* Chat Header */}
            ...
            return (
                <div key={index} className={`flex ${isSentByUser ? "justify-end" : "justify-start"}`}>
                    <div className={`px-4 py-2 rounded-lg text-white max-w-[70%] ${
                        isSentByUser ? "bg-blue-500" : "bg-gray-600 dark:bg-gray-800"
                    }`}>
                        {message.text}
                    </div>
                </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 p-4">
        <div className="flex items-center max-w-2xl mx-auto">
          <input
            type="text"
            className="flex-1 p-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
            value={messageInput}
