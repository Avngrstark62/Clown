  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
      <div className="text-center">
        ...
        />
        <h2 className="text-xl font-bold dark:text-gray-200">{userData.name || userData.username || 'Guest'}</h2>
      ...
      <div className="mt-4 text-center">
        <p className="text-gray-700 dark:text-gray-200">{userData.bio || null}</p>
