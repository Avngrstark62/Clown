...
const Connections = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 px-4 sm:px-6 lg:px-8 pt-16">
      <div className="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
        {/* Tab Header */}
        <div className="flex justify-center space-x-8 border-b border-gray-200 dark:border-gray-700 mb-6">
          <button
          ...
          {users.length > 0 ? (
            users.map((user) => (
              <div
                ...
                className="flex items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600 transition"
              >
